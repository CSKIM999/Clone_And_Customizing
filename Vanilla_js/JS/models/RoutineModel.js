export default {
  data: [
    {name:'R1' , detail:{'FLANK':[[4,5,10],[4,10,10],[4,15,10],[4,15,20]], 'e2':[[4,5,10],[4,10,10],[4,15,10],[4,15,20]],'e3':[[4,5,10],[4,10,10],[4,15,10],[4,15,20]],'e4':[[4,5,10],[4,10,10],[4,15,10],[4,15,20]]}},
  ...
  add(name='',detail=[]){
    ...
    if (!detail) return console.error("하나 이상의 Routine을 추가해주세요")
  }
}